  ...
  return (
    <Paper elevation={3} sx={{ p: 3, mt: 3 }}>
      ...
      <Dialog open={deleteDialogOpen} onClose={handleDialogClose}>
        <DialogTitle>Видалити оцінку</DialogTitle>
        <DialogContent>
          <DialogContentText>Ви впевнені, що хочете видалити цю оцінку?</DialogContentText>
        </DialogContent>
        <DialogActions>
...
export default GradeAdminUpdateForm;
